Compiling instructions:
    ...
    the sort_refugees() function that I made for my solution. I think the reason
    for this is because I didn't include the sort_refugees() function inside of the
    header file. I was told not to change the header file so I decided not to touch it. 
    The only thing I changed was increasing the size of the MAX_ID variable to 11 from 
    10 because it was originally supposed to be equal to 11. That being said, I only 
    created the sort_refugees() function inside of my refugee.c file, but I still call 
    it inside main.c. The program runs just fine despite the compiler warning and it 
    still allows me to use the function.
